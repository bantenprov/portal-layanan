...
class BantenprovLayananSeeder extends Seeder
{
    /* text color */
    ...
    protected $fileName = "BantenprovLayananSeeder.csv";
    ...
    public function __construct(){
        ...
        $this->model = new Bantenprov\Layanan\Models\Bantenprov\Layanan\Layanan;
